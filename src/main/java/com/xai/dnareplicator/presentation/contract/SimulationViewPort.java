package com.xai.dnareplicator.presentation.contract;
...
/**
 * Narrow presentation port for application services (no JavaFX types).
 */
public interface SimulationViewPort {
